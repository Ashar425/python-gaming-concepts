...
def draw():
    ...
    for answer_box in answer_boxes:
        screen.draw.filled_rect(answer_box,"teal")
    ...
    screen.draw.textbox(str(time_left),timer_box,color="white",shadow=(0.5,0.5),scolor="cyan")
    screen.draw.textbox("skip",skip_box,color="white",angle=-90)
    screen.draw.textbox(question[0].strip(), question_box,color="white",shadow=(0.5,0.5),scolor="cyan")
