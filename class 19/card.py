...
while True:
    ...
    screen.blit(t7,(200,200))
    screen.blit(t8,(200,250))

    time.sleep(2)
    pygame.display.update()

    screen.blit(img5,(0,0))
    screen.blit(t9,(200,200))
    screen.blit(t10,(200,250))

    time.sleep(2)
    pygame.display.update()

    screen.blit(img6,(0,0))
    screen.blit(t11,(200,200))
    screen.blit(t12,(200,250))
